        ...
        return (
          <>
            ...
            >
                ...
                <input
                  ...
                  <div className="ml-2">
                    ...
                    {errors.title ? (
                      <button
                      onClick={() => reset()}
                      className="bg-transparent text-md font-bold text-darkPurple outline-none"
                    >
                      Reset
                    </button>
                    ) : (
                      <input
                        type="submit"
                        value="BUAT"
                        className="bg-transparant text-md font-bold text-darkPurple outline-none"
                      />
                    )}
                  </div>
              </form>
              ...
              <button
                className="rounded-full bg-red-500 text-white font-bold text-md py-2 mt-2 px-4"
                onClick={handleOnClose}
              >
                Batal
              </button>
